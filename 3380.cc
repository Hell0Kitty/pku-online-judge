...
bool com1(Edge &a, Edge &b) { return a.has > b.has; }
bool com2(Edge &a, Edge &b) { return a.has < b.has; }
Edge edges[100010];
__int64 head[100010];
__int64 eloc;
void addEdge(__int64 x, __int64 y, __int64 dis, __int64 id) {
  edges[eloc].x = x, edges[eloc].y = y, edges[eloc].next = head[x],
  edges[eloc].id = id, edges[eloc].dis = dis;
