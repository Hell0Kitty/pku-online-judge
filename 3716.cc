...
void cal(int t1, int t2, int t3, int t4, double pp) {
  ...
  for (int n1 = 0; n1 < 2; n1++) {
    if (t1 < n1 || (n1 == 0 && t1 == 6)) continue;
    p1 = (n1 == 0) ? (6 - t1) / 6.0 : t1 / 6.0;
    for (int n2 = 0; n2 < 2; n2++) {
      if (t2 < n2 || (n2 == 0 && t2 == 6)) continue;
      p2 = (n2 == 0) ? (6 - t2) / 6.0 : t2 / 6.0;
      for (int n3 = 0; n3 < 2; n3++) {
        if (t3 < n3 || (n3 == 0 && t3 == 6)) continue;
        p3 = (n3 == 0) ? (6 - t3) / 6.0 : t3 / 6.0;
        for (int n4 = 0; n4 < 2; n4++) {
          if (t4 < n4 || (n4 == 0 && t4 == 6)) continue;
...
int main() {
  for (int t = 0; t < 7; t++) PT[t] = C6[t] / 64.0;
                      ...
                      for (int t3 = 0; t3 < 7; t3++) {
                        if (PTX[t3][x3] > eps)
                          for (int t4 = 0; t4 < 7; t4++) {
                            if (PTX[t4][x4] > eps) {
                              cal(t1, t2, t3, t4, PTX[t1][x1] * PTX[t2][x2] *
                                                      PTX[t3][x3] *
                                                      PTX[t4][x4]);
                            }
                          }
