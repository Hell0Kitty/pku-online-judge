...
{
  if (l[x].first.x == l[x].last.x &&
      l[y].first.x == l[y].last.x)  // l[x]为南北方向,l[y]为南北方向
  {
  ...
  } else if (l[x].first.y == l[x].last.y &&
             l[y].first.y == l[y].last.y)  // l[x]为西东方向，l[y]为西东方向
  {
  ...
  } else if (l[x].first.x == l[x].last.x &&
             l[y].first.y == l[y].last.y)  // l[x]为南北方向，l[y]为西东方向
  {
...
bool operator<(T a, T b) { return b.len < a.len; }
