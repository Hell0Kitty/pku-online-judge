...
bool ok() {
  for (int i = 0; i < 6; i += 2)
    if (pallet[i].a != pallet[i + 1].a || pallet[i].b != pallet[i + 1].b)
      return false;
  if (pallet[0].b != pallet[2].a) swap(pallet[2].a, pallet[2].b);
  if (pallet[2].b != pallet[4].a) swap(pallet[4].a, pallet[4].b);
  if (pallet[0].b == pallet[2].a && pallet[2].b == pallet[4].a &&
      pallet[4].b == pallet[0].a)
    return true;
