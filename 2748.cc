...
void init() {
  ...
  for (i = 1; i <= 30; i++) {
    tmp[i][0][0] = (tmp[i - 1][0][0] * tmp[i - 1][0][0] +
                    tmp[i - 1][0][1] * tmp[i - 1][1][0]) %
                   100000;
    tmp[i][0][1] = (tmp[i - 1][0][0] * tmp[i - 1][0][1] +
                    tmp[i - 1][0][1] * tmp[i - 1][1][1]) %
                   100000;
    tmp[i][1][0] = (tmp[i - 1][1][0] * tmp[i - 1][0][0] +
                    tmp[i - 1][1][1] * tmp[i - 1][1][0]) %
                   100000;
    tmp[i][1][1] = (tmp[i - 1][1][0] * tmp[i - 1][0][1] +
                    tmp[i - 1][1][1] * tmp[i - 1][1][1]) %
                   100000;
  }
  a[0] = 1;
  a[1] = 1;
...
int solve(int n) {
  ...
  for (i = 0; i <= 30; i++) {
    if (e[i]) {
      ...
      res[0][0] = t[0][0] % 100000, res[0][1] = t[0][1] % 100000,
      res[1][0] = t[1][0] % 100000, res[1][1] = t[1][1] % 100000;
    }
  }
