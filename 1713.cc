...
bool FillFull(int i,int j,int x,int y,int pa[],int pb[],
              int pan,int pam,int pbn,int pbm)
{
    int c[MAX]={0};
    int t;
    for(t=0;t<pan;t++)
...
bool DFS(int uprow,int downrow,int cleft,int cright,int n,int m,int Bleft,int Bright,bool Bflag)
{
