...
bool compare(const bomber &b1, const bomber &b2) { return b1.x <= b2.x; }
...
bool theSameBomber(int b1, int b2) {
  ...
  return (bombers[b1].x - bombers[b2].x) * sm ==
         (bombers[b2].y - bombers[b1].y) * sb;
}
