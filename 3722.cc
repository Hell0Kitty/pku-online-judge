...
int main()
{
    ...
    else
    {
       ...
       for(i=1;i<n;i++)
       {
          if((a[i].x!=a[cnt-1].x)||(a[i].d!=a[cnt-1].d))
               a[cnt++]=a[i];
       }
       n=cnt;
       now=cnt=0;
       ...
       {
           double x1=lt,x2=nt,x=min(list[id1+1].t-lt,list[id2+1].t-nt),dx;
           double A,B;
